...
A code for solving nonlinear boundary value problems in solid mechanics, to start, modify and run 'Run_code.mlx'.

## Instruction
This program provides both static and dynamic (alpha method) solver for 2-D boundary value problem. 
